...
export default function SectionHeader({
  ...
  return (
    <header className={classes} {...props}>
      {eyebrow && (
        <span className="inline-flex items-center rounded-full border border-border/40 bg-accent/50 px-4 py-1.5 text-xs font-bold uppercase tracking-caps text-muted-foreground backdrop-blur-sm">
          {eyebrow}
        </span>
      )}
